Shader "AlpacaSound/RetroPixel8" 
{
	Properties
	{
		...
		_Color7("Color 8", Color) = (1.00, 1.00, 1.00, 1.0)
		_Color7("Color 9", Color) = (1.00, 1.00, 1.00, 1.0)
		_Color7("Color 10", Color) = (1.00, 1.00, 1.00, 1.0)
		_Color7("Color 11", Color) = (1.00, 1.00, 1.00, 1.0)
		_Color7("Color 12", Color) = (1.00, 1.00, 1.00, 1.0)
		_Color7("Color 13", Color) = (1.00, 1.00, 1.00, 1.0)
		_Color7("Color 14", Color) = (1.00, 1.00, 1.00, 1.0)
		_Color7("Color 15", Color) = (1.00, 1.00, 1.00, 1.0)
		_Color7("Color 16", Color) = (1.00, 1.00, 1.00, 1.0)
		_Color7("Color 17", Color) = (1.00, 1.00, 1.00, 1.0)
		_Color7("Color 18", Color) = (1.00, 1.00, 1.00, 1.0)
		_Color7("Color 19", Color) = (1.00, 1.00, 1.00, 1.0)
		_Color7("Color 20", Color) = (1.00, 1.00, 1.00, 1.0)
		_Color7("Color 21", Color) = (1.00, 1.00, 1.00, 1.0)
		_Color7("Color 22", Color) = (1.00, 1.00, 1.00, 1.0)
		_Color7("Color 23", Color) = (1.00, 1.00, 1.00, 1.0)
	 	_MainTex ("", 2D) = "white" {}
	}
